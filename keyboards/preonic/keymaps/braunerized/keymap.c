 ...
 * |          |   Z  |   X  |   C  |   V  |   B  |   N  |   M        |   ,  |   .  |   /  |            |
 * |----------+------+------+------+------+------+------+------------+------+------+------+------------|
 * |          |      |Layer2|Raise |Lower | Alt  |      |Lower/Space |Raise |Layer2|      |            |
 * `---------------------------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_preonic_grid(
  ...
  _______,          _______, LAYER2,  RAISE, LOWER, KC_LALT, _______, MOD_TAP_LOWER_SPC, RAISE,   LAYER2, _______, _______
),
...
[_RAISE] = LAYOUT_preonic_grid(
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
  _______, KC_HASH, _______, _______, _______, _______, _______, KC_CIRC, KC_MINS, KC_GT,   KC_EQL,  _______,
