 ...
 * |          |   Z  |   X  |   C  |   V        |   B  |   N  |   M        |   ,  |   .  |   /  |            |
 * |----------+------+------+------+------------+------+------+------------+------+------+------+------------|
 * |          |      |Layer2|Raise |Lower/Space | Alt  |      |Lower/Space |Raise |Layer2|      |            |
 * `---------------------------------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_preonic_grid(
  ...
  _______,          _______, LAYER2,  RAISE, MOD_TAP_LOWER_SPC, KC_LALT, _______, MOD_TAP_LOWER_SPC, RAISE,   LAYER2, _______, _______
),
...
[_RAISE] = LAYOUT_preonic_grid(
  ...
  _______, _______, _______, _______, _______, _______, KC_BSPC, KC_PGDN, KC_PGUP, KC_TAB,  KC_DLR,  _______,
