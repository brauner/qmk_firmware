 ...
 * |------+------+------+--------------+--------------+------------------+-----------+---------+------------+------+------|
 * |      |      |      |   Button 2   |   Button 1   |      |Cursor Left|Cursor Down|Cursor Up|Cursor Right|      |      |
 * |------+------+------+--------------+--------------+------|-----------+-----------+---------+------------+------+------|
 * |      |      |      |              |              |      |           |           |         |            |      |      |
 * |------+------+------+--------------+--------------+------+-----------+-----------+---------+------------+------+------|
 * |      |      |      |Accelaration 1|Accelaration 0|      |           |           |         |            |      |      |
 * `----------------------------------------------------------------------------------------------------------------------'
 */
[_MOUSE1] = LAYOUT_preonic_grid(
  ...
  _______, _______, _______, _______,      _______,      _______, _______,       _______,       _______,     _______,        _______, _______,
  _______, _______, _______, KC_MS_ACCEL1, KC_MS_ACCEL0, _______, _______,       _______,       _______,     _______,        _______, _______),
